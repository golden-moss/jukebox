...
// // yoink: https://github.com/aome510/spotify-player/blob/master/spotify_player/src/media_control.rs
...
//         let dummy_window = window::fetch_id(window::Id::MAIN, |_| 0);
//         let handle = Some(dummy_window as _);
//         (handle, dummy_window)
//     };
